"""
Страница прогноза внешнеторгового оборота: Россия—Китай.
Модели:
...
from data.diploma_data import factors_cn_df

# =============================================================
# ВШИТЫЕ НАСТРОЙКИ ДЛЯ ЗАЩИТЫ ДИПЛОМА
# =============================================================
PAIR_LABEL = "Россия—Китай"
DEFAULT_FACTORS = ['Курс USD/RUB', 'ВВП России', 'Темп роста ВВП России']
...
st.set_page_config(page_title="Прогноз Россия-Китай", page_icon=None, layout="wide")
...
<div style="margin-bottom:1.2rem;">
    ...
    <h1 style="margin:0;">Прогноз Россия-Китай</h1>
...
# =============================================================
rss_signal = collect_rss_signal(PAIR_LABEL, ['Россия Китай торговля', 'Russia China trade', 'Russia China economic cooperation', 'Россия Китай экономика'])
